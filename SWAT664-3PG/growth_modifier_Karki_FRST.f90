        subroutine growth_modifier_3PG_FRST
...
!Calculation of fphys -------------------------------------------------------------------------------------------
        ...
        if (foliage_debt(j) > 0.) then
            ...
            !foliage_debt(j) = foliage_debt(j) - (bioday3PG(j))
        ...
        !!===================
         ...
         !! Junyu Qi 02/26/2022  use  pltfr_n(j) and pltfr_p(j) for all biomass component for now.     
