...
!! process input
      ...
      call readatmodep
      call readinpt
      call readSWAT3PGinp     !!SWAT-3PG, Ritesh - new subroutine to read  forest parameters needed for the 3PG module
      call std1
      call std2
      call openwth
      call headout
      call headout_forest     !!SWAT-3PG, Ritesh -  forest output
