      subroutine plantmod_forest !!!The subroutine is plantmod for all other plants
...
!$$$$$$       end if
 ...
 !     call operatn
      ...
      !!-------Ritesh-----forestry-----call new grow routine for forests----------
      if (igro(j) == 1) call swu
 
      if (igro(j) == 1) call grow_forest ! SWAT-3PG
      ! call grow_forest   
