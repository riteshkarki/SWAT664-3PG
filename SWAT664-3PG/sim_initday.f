...
!-----------------------------------------------------        
	...
	sub_rspc_d =0.
      ...
      !! SWAT-3PG--------------------
        !!Added by Ritesh
        !!Initializing foliage, biomass, and root, increment as well as losses to 0 for beginning of day
        foliage_incr = 0.
        stem_incr = 0.
        root_incr = 0
        bio_loss_foliage = 0.
        ...
        OrgC_Plt2Rsd_dor = 0. !Ritesh - new varibale to track biomass loss from dormancy
      !! SWAT-3PG--------------------
